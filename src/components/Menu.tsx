            ...
            if (item.visible.includes(role)) {
              return (
                <Link
                  href={item.href}
                  key={item.label}
                  className="flex items-center justify-center lg:justify-start gap-4 text-gray-500  py-1 md:px-2 rounded-md hover:bg-lamaSkyLight" //hover:text-black hover:bg-gray-200  hover:font-bold hover:rounded
                >
                  <Image
                    src={item.icon}
                    alt=""
